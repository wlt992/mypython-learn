...
# 训练神经网络
def test_neural_network(input_image):
	...
	with tf.Session() as sess:
		...
		while True:
			...
			if(random.random() <= epsilon): # 看是否随机选择移动方向
...
test_neural_network(input_image)